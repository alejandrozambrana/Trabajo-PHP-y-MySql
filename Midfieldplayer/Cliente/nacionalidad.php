...
<html>
  ...
  <body>
          ...
          <nav>
            ...
            <div class="opcionesOcultas">
              <ul>
                ...
                <li id="activate"><a href="nacionalidad.php"><span class="sprite sprite-nacionalidad"></span> Nacionalidades</a></li>  
              </ul>
    ...
    ?>
      ...
      <h1 id="titulo3D">Nacionalidades</h1>
    ...
    ?>
          <div class="flex-item">
            <p><b>Codigo: </b><?= $nacionalidad->codnac ?></p>
